...
def get_gold_data():
    return jsonify({
        ...
        "entryAdvices": [
            {"timeframe": "15M (Scalping)", "buy": "$4,750 – $4,775", "tp": "$4,850", "sl": "$4,735", "colorHex": "green"},
            {"timeframe": "4H (Intraday)", "buy": "$4,604 – $4,680", "tp": "$5,050", "sl": "$4,580", "colorHex": "orange"},
            {"timeframe": "Daily (Swing)", "buy": "$4,405 – $4,550", "tp": "$5,300", "sl": "$4,350", "colorHex": "blue"}
        ],
        "newsUpdates": [
            ...
            {"title": "US Govt Shutdown", "impact": "BULLISH", "description": "Safety bid amid fiscal darkness."}
        ]
    })
